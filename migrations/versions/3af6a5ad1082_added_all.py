...
Revision ID: 3af6a5ad1082
Revises: 68d4cf0df46c
Create Date: 2024-05-18 21:40:34.328319
...
revision: str = '3af6a5ad1082'
down_revision: Union[str, None] = '68d4cf0df46c'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('diagnosis', 'patient_id', 'doctor_id', 'date')
    )
